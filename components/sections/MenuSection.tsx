...
export default async function MenuPage() {
    ...
    return (
        <section id="menu" className="relative overflow-hidden bg-light-cafe flex flex-col items-center justify-center p-6 min-h-screen">
            ...
            {/* --- Основной контент (z-10 чтобы быть поверх картинок) --- */}
